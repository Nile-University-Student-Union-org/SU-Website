...
export const Route = createRootRoute({
  head: () => ({
    meta: [
      ...
      { name: "theme-color", content: "#0F3056" },
      ...
      { property: "og:image:alt", content: "Nile University Student Union" },
