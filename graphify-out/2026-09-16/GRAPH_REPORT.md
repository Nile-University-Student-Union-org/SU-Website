...
Cohesion: 0.02
Nodes (126): AboutCTAScalarFieldEnum, AboutHeroScalarFieldEnum, AccountScalarFieldEnum, AnyNull, Args, At, AtLeast, AtLoose (+118 more)
...
### Community 3 - "cn"
Cohesion: 0.04
Nodes (72): input-otp, NavLink(), Accordion(), AccordionContent(), AccordionItem(), AccordionTrigger(), AlertDialogMedia(), AlertDialogOverlay() (+64 more)

### Community 4 - "routeTree.gen.ts"
Cohesion: 0.04
Nodes (64): getRouter(), Register, @tanstack/react-router, Route, Route, Route, Route, Route (+56 more)
...
Cohesion: 0.06
Nodes (43): Sheet(), SheetContent(), SheetDescription(), SheetFooter(), SheetHeader(), SheetOverlay(), SheetTitle(), SheetTrigger() (+35 more)

### Community 11 - "admin.events.tsx"
Cohesion: 0.14
Nodes (50): date-fns, @hugeicons/core-free-icons, @hugeicons/react, react, sonner, AdminShell(), ImageUploader(), Props (+42 more)
...
### Community 24 - "validators.ts"
Cohesion: 0.08
Nodes (36): AdminFieldRow(), Switch(), Textarea(), AboutCTAPage(), onSubmit(), AboutHeroPage(), onSubmit(), Route (+28 more)

### Community 25 - "calendar/index.tsx"
Cohesion: 0.05
Nodes (50): jotai, CalendarBody(), CalendarBodyProps, CalendarContext, CalendarContextProps, CalendarDatePagination(), CalendarDatePaginationProps, CalendarDatePicker() (+42 more)
...
Cohesion: 0.07
Nodes (37): @tanstack/react-router, CTASection(), HeroSection(), CommitteeData, MissionSection(), StatData, WhoWeAreData, Navbar() (+29 more)
...
Cohesion: 0.06
Nodes (34): name, private, type, @base-ui/react, clsx, dotenv, @fontsource/poppins, @fontsource-variable/geist (+26 more)
...
Cohesion: 0.11
Nodes (18): class-variance-authority, Alert(), AlertAction(), AlertDescription(), AlertTitle(), alertVariants, Badge(), badgeVariants (+10 more)
...
Cohesion: 0.08
Nodes (25): AboutCTA, AboutHero, Account, BoardMember, Committee, ContactInfo, ContactSubmission, $Enums (+17 more)
...
Cohesion: 0.05
Nodes (68): PrismaClient, @tanstack/react-start, zod, BoardPage(), handleDelete(), MemberDialog(), onSubmit(), Route (+60 more)
...
Cohesion: 0.20
Nodes (11): better-auth, authClient, AdminLogin(), loginSearchSchema, AuthSession, ac, AdminRole, statement (+3 more)
...
### Community 96 - "SiteFooter.tsx"
Cohesion: 0.29
Nodes (7): ContactInfoData, FooterData, getIcon(), ICON_MAP, navLinks, SiteFooter(), SocialLinkData
...
Cohesion: 0.40
Nodes (3): @tanstack/react-devtools, @tanstack/react-router-devtools, Toaster()
...
### Community 114 - "image-requirements.ts"
Cohesion: 0.50
Nodes (3): IMAGE_REQS, ImageRequirement, ImageRequirementKey
...
### Community 133 - "AdminLayout"
Cohesion: 0.40
Nodes (4): AdminLayout(), signOut(), useTheme(), toggle()
...
## Knowledge Gaps
- **2124 isolated node(s):** `YourNamespace.Infrastructure.Data`, `Products`, `Categories`, `Orders`, `OrderItems` (+2119 more)
  These have ≤1 connection - possible missing edges or undocumented components. (Counts symbols only; 2654 node(s) total have ≤1 connection when file, concept and rationale nodes are included.)
- **56 thin communities (<3 nodes) omitted from report** — run `graphify query` to explore isolated nodes.

## Suggested Questions
_Questions this graph is uniquely positioned to answer:_

- **Why does `@prisma/adapter-pg` connect `client.ts` to `package.json`, `requireAdmin`?**
  _High betweenness centrality (0.132) - this node is a cross-community bridge._
- **Why does `prisma` connect `requireAdmin` to `validators.ts`, `admin/events.ts`, `auth.ts`, `@tanstack/react-router`?**
  _High betweenness centrality (0.037) - this node is a cross-community bridge._
- **Why does `react` connect `admin.events.tsx` to `chart.tsx`, `package.json`, `cn`, `sidebar.tsx`, `auth.ts`, `item.tsx`, `validators.ts`, `class-variance-authority`, `carousel.tsx`, `context-menu.tsx`, `calendar/index.tsx`, `pagination.tsx`, `menubar.tsx`, `@tanstack/react-router`, `drawer.tsx`, `combobox.tsx`?**
